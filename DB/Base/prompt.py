    ...
    def _generate_numbered_list(self, items: list, item_type: str = "list") -> str:
        ...
        if item_type == "command":
            ...
            finish_args = (
                ...
                'CEO know you have finished your objectives，and that final response needs to include detailed results."'
            )
            finish_string = (
...
def get_prompt(tools: List[BaseTool]) -> str:
    ...
    prompt_generator.add_constraint("Don't over accomplish goal.")
    prompt_generator.add_constraint(
